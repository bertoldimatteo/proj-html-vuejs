...
import CardHero from '../blockComponents/CardHero.vue';
...
header {
    background-image: linear-gradient(rgba(220,109,111,0.9), rgba(220,109,111,0.9)), url('../../assets/reference/img/theme_slider2_bg-1.jpg');
